...
const validRecipe = ({ name, description, prep_time, cook_time }) => {
  // Required fields
  const fieldsPresent = name && description && prep_time && cook_time
  // Data types
  ...
  return fieldsPresent && validName && validDescription && validPrep && validCook && validPrep && validCook
}
